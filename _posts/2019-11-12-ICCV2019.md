...
Similarly, it is even difficult for humans to do multi-tasking. One interesting example that was shown was counting guerilla.

<iframe width="400" height="300" src="https://www.youtube.com/embed/vJG698U2Mvo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

  

The solution to this problem is to give each task space i.e. divide the network into shared and task-specific space.
...
- [Why Does Data-Driven Beat Theory-Driven Computer Vision?](http://openaccess.thecvf.com/content_ICCVW_2019/papers/NeurArch/Tsotsos_Why_Does_Data-Driven_Beat_Theory-Driven_Computer_Vision_ICCVW_2019_paper.pdf]

  

- [GeoStyle: Discovering Fashion Trends and Events

](https://arxiv.org/abs/1908.11412)
...
![](https://lh3.googleusercontent.com/UWatJm9p_eg8pD-Vryc-jaUO7fdqTjvteC9f7_e2h4ZDn3zwepfTMccPDlXKzYANSFY3YO5BB-WY) | ![](https://lh3.googleusercontent.com/C-5_c_xDIHvfNT1XrC2vG5gf1cPWCyMdbK_6zaY8yaWStV0vzlRPghz1zsYLvU4pYZ97zr21djpB) | ![](https://lh3.googleusercontent.com/yuZGIiTM7pEP-xBI7MHzDo63Ln9CBjkRFHO0apOhTJmIN2hRPpVdMuwJpPBye_CH0YLgftC3M8SI)
